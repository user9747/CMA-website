      ...
      >
        <div className="bg-black flex items-center justify-center w-full h-full">
          <div className="w-[90%] sm:w-[90%] text-white text-xs sm:text-xl font-light sm:leading-6">
            ...
            ARCHITECTS, TECHNOCRATS AND A PASSION FOR SUSTAINABILE,
            ...
            <br /> <br />
            OUR AIM IS TO MAKE SPCES THAT NOT ONLY FUNCTION SEAMLESSLY BUT ALSO
            EXUDE BEAUTY AND HARMONY......A SOURCE OF INSPIRATION AND JOY.
            <br /> <br />
            WE TRY TO CRAFT NARRATRIVES OF DESIGNS WITH MATERIALS, COLOURS AND
